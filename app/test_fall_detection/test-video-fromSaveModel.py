...
model = tf.saved_model.load('/workspace/output/tftrt_saved_model')

# Open a video file or capture device
video_path = '/workspace/data/video.mp4'  # Change to your video path
output_dir = '/workspace/output'  # Output folder path
